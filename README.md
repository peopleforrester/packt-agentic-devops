...
[![Components](https://img.shields.io/badge/components-29%20pinned-2e9e5b.svg)](components.yaml)
...
| **29 components** | every one version-pinned in [`components.yaml`](components.yaml) and frozen before the event |
